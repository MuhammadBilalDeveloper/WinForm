    ...
    public partial class frmMyPage : XtraForm
    {
        ...
        public static frmMyPage Getinstance
        {
            get
            {
                ...
                {
                    instance = new frmMyPage(new SQLServerCustomerRepositry());
                }
                return instance;
            }
        }
